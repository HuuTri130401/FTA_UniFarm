...
namespace Capstone.UniFarm.Domain.Migrations
{
    ...
    [Migration("20240415090014_UpdateStringValueAndRemoveUnusedtable")]
    partial class UpdateStringValueAndRemoveUnusedtable
    {
            ...
            modelBuilder.Entity("Capstone.UniFarm.Domain.Models.Batch", b =>
                {
                    ...
                    b.Property<DateTime?>("CollectedHubReceiveDate")
                        .HasColumnType("datetime2");

                    b.Property<Guid>("CollectedId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("CollectedStaffProcessId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("FarmHubId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateTime?>("FarmShipDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Capstone.UniFarm.Domain.Models.Transaction", b =>
                {
                    ...
                    b.HasOne("Capstone.UniFarm.Domain.Models.Wallet", "PayerWallet")
                        .WithMany("TransactionsAsPayers")
            ...
            modelBuilder.Entity("Capstone.UniFarm.Domain.Models.Wallet", b =>
                {
                    ...
                    b.Navigation("TransactionsAsPayers");
                });
