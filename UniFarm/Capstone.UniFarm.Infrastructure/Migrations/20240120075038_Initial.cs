        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegiterDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BusinessDate", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Collected__Accou__3C69FB99",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__FarmHub__Account__45F365D3",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Station__Account__412EB0B6",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Wallet__AccountI__5CD6CB2B",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinMargin = table.Column<double>(type: "float", nullable: true),
                    MaxMargin = table.Column<double>(type: "float", nullable: true),
                    Margin = table.Column<double>(type: "float", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PriceSystem", x => x.Id);
                    table.ForeignKey(
                        name: "FK__PriceSyst__Categ__4CA06362",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Menu__FarmHubId__71D1E811",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Product__Categor__5165187F",
                        column: x => x.CategoryId,
                        principalTable: "Category",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__Product__FarmHub__5070F446",
                        column: x => x.FarmHubId,
                        principalTable: "FarmHub",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BusinessDateId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SessionMenu", x => x.Id);
                    table.ForeignKey(
                        name: "FK__SessionMe__Busin__7F2BE32F",
                        column: x => x.BusinessDateId,
                        principalTable: "BusinessDate",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__SessionMe__MenuI__7E37BEF6",
                        column: x => x.MenuId,
                        principalTable: "Menu",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__ProductIm__Produ__5535A963",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__ProductIt__Produ__59063A47",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__ProductMe__MenuI__75A278F5",
                        column: x => x.MenuId,
                        principalTable: "Menu",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__ProductMe__Produ__76969D2E",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StationHubId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "(getdate())"),
                    ...
                    FarmHubStatus = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    CollectedHubStatus = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    StationStatus = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Order__CustomerI__6754599E",
                        column: x => x.CustomerId,
                        principalTable: "Accounts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__Order__FarmHubId__66603565",
                        column: x => x.FarmHubId,
                        principalTable: "FarmHub",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__Order__StationHu__693CA210",
                        column: x => x.StationHubId,
                        principalTable: "Station",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__Order__Transacti__68487DD7",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Batch__Collected__02FC7413",
                        column: x => x.CollectedId,
                        principalTable: "CollectedHub",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__Batch__FarmHubId__03F0984C",
                        column: x => x.FarmHubId,
                        principalTable: "FarmHub",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__Batch__OrderId__04E4BC85",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__OrderDeta__Order__6D0D32F4",
                        column: x => x.OrderId,
                        principalTable: "Order",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__OrderDeta__Produ__6E01572D",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Transfer__Collec__08B54D69",
                        column: x => x.CollectedId,
                        principalTable: "CollectedHub",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__Transfer__OrderI__0A9D95DB",
                        column: x => x.OrderId,
                        principalTable: "Order",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__Transfer__Statio__09A971A2",
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Collecte__349DA5A778107679",
                table: "CollectedHub",
                column: "AccountId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__FarmHub__349DA5A74EF17F52",
                table: "FarmHub",
                column: "AccountId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PriceSystem_CategoryId",
                table: "PriceSystem",
                column: "CategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SessionMenu_BusinessDateId",
                table: "SessionMenu",
                column: "BusinessDateId");

            migrationBuilder.CreateIndex(
                name: "IX_SessionMenu_MenuId",
                table: "SessionMenu",
                column: "MenuId");

            migrationBuilder.CreateIndex(
                name: "UQ__Station__349DA5A773F32A92",
                table: "Station",
                column: "AccountId",
                unique: true);
