...
export interface IListUtilContext {
    pageSize: number;
    page: number;
    totalItem: number;
    sortField: string;
...
const ListUtilContext = React.createContext<IListUtilContext>({
    pageSize: 10,
    page: 1,
    totalItem: 0,
    handleOnChangePage: () => {},
...
export interface ListProviderProps extends React.PropsWithChildren {}

export const ListUtilProvider: React.FC<ListProviderProps> = ({ children }) => {
...
export const useListUtil = () => {
    const context = React.useContext(ListUtilContext);
